...
CEGUI can create a GUI layout for the application and saves it as a text file
*/
...
void BasicTutorial7::createScene(void)
{
    ...
    // These are the default resource groups for CEGUI
    ...
    // .scheme is used to give the whole application a theme
    CEGUI::SchemeManager::getSingleton().create("TaharezLook.scheme");
 
    // Sets the mouse cursor to be Taherz Look
    CEGUI::System::getSingleton().setDefaultMouseCursor("TaharezLook", "MouseArrow");
 

    //Creates a window where the quit button will be?
    ...
    // Connects the quit button to the function BasicTutorial7::quit. So on click you run the quit function
    quit->subscribeEvent(CEGUI::PushButton::EventClicked,
    CEGUI::Event::Subscriber(&BasicTutorial7::quit, this));
 
    //You can have a CEGUI widget that is a second viewport
    ...
    //Creates the cam and viewport for the rendertexture. Disables overlaps ogre overlays
...
/* You override the BaseApplication createFrameListener */
void BasicTutorial7::createFrameListener(void)
{
 ...
 /* You override the BaseApplication frameRenderingQueued */
...
bool BasicTutorial7::keyPressed( const OIS::KeyEvent &arg )
{
    ...
    // If the esc key is push it starts a shutdown
...
{
    // OIS and CEGUI do not share the same mouse buttons so this converts OIS into CEGUI buttons
    switch (buttonID)
    {
    case OIS::MB_Left:
